        ...
        <article className="overflow-hidden rounded-2xl bg-card shadow-2xl ring-1 ring-border">
          ...
          <div className="bg-white px-6 py-10 sm:px-10 sm:py-12">
            <header className="mb-8 border-b border-zinc-200 pb-8 text-center">
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-accent text-sm font-bold text-foreground">R</span>
            ...
            <div className="mt-10 rounded-xl bg-zinc-50 p-6 text-center">
              ...
              <Link href="/dashboard" className="mt-4 inline-block rounded-lg bg-accent px-6 py-2.5 text-sm font-semibold text-foreground">View all picks</Link>
            </div>
