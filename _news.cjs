const SITE_URL="https://recon.com.ng"; const unsubscribeUrl=(t)=>SITE_URL+"/api/unsubscribe?token="+t;
...
require("node:fs").writeFileSync("news-preview.html", newsEmailHtml({title:"We just shipped personalized picks", body:"Big news this week.

Your Friday email now learns from what you love.

Thanks for being here.", images:["https://res.cloudinary.com/dgbl43ljm/image/upload/v1779293269/rencom/forgotten_vyobdh.jpg"], ctaText:"See what changed", ctaUrl:"https://recon.com.ng", unsubscribeToken:"demo-token"}));